...
html
{ 
    background-image:url('g2.gif'); background-repeat:repeat; 
}#header ul li{
	list-style:none;
...
<div class="container"  >
<div id="wrapper">
  <h1><center><b>Sustain Energy Portal</b></center></h1>
  ...
  <ul class="nav nav-pills">
    <li class="btn btn-default btn-xs"><a href="homeClient.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
